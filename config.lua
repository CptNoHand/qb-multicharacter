...
Config.PedCoords = vector4(2225.78, 2913.34, -84.8, 19.81) -- Create preview ped at these coordinates
Config.HiddenCoords = vector4(3.3, 523.88, 170.62, 70.87) -- Hides your actual ped while you are in selection
Config.CamCoords = vector4(2226.28, 2913.34, -84.8, 185.5) -- Camera coordinates for character preview screen
